...
public abstract class Canvas extends JPanel implements KeyListener, MouseListener {
    ...
    public Canvas() {
        ...
        //If you will draw your own mouse cursor or if you just want that mouse cursor to disappear, insert "true"
        // into if condition and mouse cursor wil be removed.
        ...
        this.addKeyListener(this); // this is for working with the keyboard.

        // Adds the mouse listener to JPanel to receive mouse events from this component.
        this.addMouseListener(this); // this is for working with the mouse (with buttons).
    }
     ...
     * true if the key is down, false if the key is not down.
     */
